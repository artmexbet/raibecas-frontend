...
### ✅ Обновление API документации (NEW!)
Полностью обновлена OpenAPI спецификация в соответствии с реальной реализацией Gateway API:
- Добавлены новые endpoints для аутентификации (refresh, validate, logout-all, change-password)
- Обновлены схемы данных для Documents, Users, Registration Requests
- Добавлена поддержка cookie-based refresh tokens
- Исправлены HTTP методы (PATCH вместо PUT для обновлений)
- Добавлены правильные коды ошибок и структуры ответов

### ✅ Drag & Drop загрузка документов
Реализована функциональность загрузки Markdown файлов через Drag & Drop с автоматическим извлечением метаданных из YAML front matter.

### ✅ Добавление новых документов
Реализована возможность создания новых научных работ философов с полноценной формой и предпросмотром Markdown.

### ✅ Организованная система моков
...
- ✅ `src/components/DocumentViewer.tsx` - переиспользуемый компонент для отображения документов
...
- ✅ `src/types/document.ts` - типы для документов
- ✅ `src/types/permissions.ts` - роли и права доступа
...
- ✅ `src/services/document.service.ts` - CRUD операции для документов
...
### Раздел 2.1: Список документов ✅
- ✅ Создана страница со списком всех работ
- ✅ Таблица с основными колонками
- ✅ Пагинация
...
### Раздел 2.2: Загрузка новых документов ✅
- ✅ Создана форма загрузки документа
- ✅ **Drag & Drop загрузка Markdown файлов**
- ✅ Форма метаданных документа (название, автор, описание, категория, дата, теги)
- ✅ Предпросмотр Markdown в реальном времени
- ✅ **Автоматическое извлечение метаданных из YAML front matter**
- ✅ Валидация формата файла (.md, .markdown)
- ✅ Валидация обязательных полей
- ✅ Отправка на backend (через моки)
- ✅ Обработка ошибок при загрузке
- ✅ Уведомления об успешной загрузке
- ✅ Кнопка очистки содержимого

### Раздел 2.3: Редактирование документов ✅
- ✅ Страница редактирования существующего документа
- ✅ Загрузка данных документа
- ✅ Редактирование метаданных и содержимого
- ✅ Сохранение изменений

### Раздел 2.4: Просмотр документов ✅
- ✅ Страница просмотра документа
- ✅ Переиспользуемый компонент DocumentViewer
- ✅ Отображение метаданных
- ✅ Рендеринг Markdown содержимого
- ✅ Статистика по просмотрам и заметкам
