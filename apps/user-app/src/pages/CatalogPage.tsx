...
import { Masonry, Typography, Spin, Empty, Pagination, theme, Button, Space } from 'antd';
import {
  EditFilled,
  TeamOutlined,
  FileTextOutlined,
...
import { AppHeader, PageBackground, DocumentCard } from '@/components/common';
              ...
              return (
                <Button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    padding: '8px 12px',
                    background: activeFilter === filter.key ? `${token.colorPrimary}15` : 'transparent',
                    color: activeFilter === filter.key ? token.colorPrimary : token.colorText,
